...
public class CampeonatoControllerTest extends BaseApiIntegrationTest{
    ...
    @Tag("IntegrationTest")
    @Tag("ApiTest")
    @DisplayName("Should return 400 when championship name is Empty")
    ...
    @Tag("IntegrationTest")
    @Tag("ApiTest")
    @DisplayName("Should return 400 when championship name is too long")
    void shouldReturnBadRequestWhenNameExceedsMaxLength() {
    ...
    @Tag("IntegrationTest")
    @Tag("ApiTest")
    @DisplayName("Should not allow creating championship with more than 32 teams")
    void shouldNotAllowCreatingChampionshipWithMoreThan32Teams() {
        List<TeamDTO> teams = Arrays.asList(
                new TeamDTO(UUID.fromString("a1111111-1111-1111-1111-111111111111"), "Manchester United"),
                new TeamDTO(UUID.fromString("a2222222-2222-2222-2222-222222222222"), "Real Madrid"),
                new TeamDTO(UUID.fromString("a3333333-3333-3333-3333-333333333333"), "Barcelona"),
                ...
                new TeamDTO(UUID.fromString("d4444444-4444-4444-4444-444444444444"), "Olympique de Marseille"),
                new TeamDTO(UUID.fromString("d5555555-5555-5555-5555-555555555555"), "Celtic"),
                new TeamDTO(UUID.fromString("d6666666-6666-6666-6666-666666666666"), "Paysandu")
        );
        CampeonatoRequestDTO request = new CampeonatoRequestDTO("Campeonato Grande Demais", teams);
        given().header("Authorization", "Bearer " + authToken).contentType(ContentType.JSON).body(request).when().post("/api/v1/campeonatos")
                .then().statusCode(400).log().all();
    }
    @Test
    @Tag("IntegrationTest")
    ...
    @Tag("IntegrationTest")
    @Tag("ApiTest")
    @DisplayName("Should not permit SQL injection is attempted in name")
    void shouldNotPermitSqlInjectionInName() {
        String sqlInjection = "'; DROP TABLE tableTest; --";
